            ...
            <div class="col-lg-8 ml-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-3" id="delivery_option">
                             <label class="col-md-3 col-from-label">Dilevery Option <span class="text-danger">*</span></label>
                             <div class="col-md-8">
                             <div class="input-type-check d-flex flex-wrap ml-5">
                              
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="global"  name="delivery_option[]" 
                                         {{ isset($delivery_options["global"]) ? 'checked' : ''  }} id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Global
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="limited_international" name="delivery_option[]" 
                                        {{ isset($delivery_options["limited_international"]) ? 'checked' : ''  }}  id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Limited International
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="national" name="delivery_option[]" 
                                        {{ isset($delivery_options["national"]) ? 'checked' : ''  }} id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            National
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="limited_national" name="delivery_option[]" 
                                        {{ isset($delivery_options["limited_national"]) ? 'checked' : ''  }} id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Limited National
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="locak_delivery" name="delivery_option[]"
                                        {{ isset($delivery_options["locak_delivery"]) ? 'checked' : ''  }} id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Locak Delivery
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="picup" name="delivery_option[]" 
                                        {{ isset($delivery_options["picup"]) ? 'checked' : ''  }}  id="flexCheckChecked">
                        ...
                        <div class="form-group row mt-3" id="shipping_type">
                             <label class="col-md-3 col-from-label">Shipping Type <span class="text-danger">*</span></label>
                             <div class="col-md-8">
                             <div class="input-type-check d-flex flex-wrap ml-5">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="within_usa"  name="shipping_type[]" 
                                        {{ isset($shipping_types["within_usa"]) ? 'checked' : ''  }}  id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Within USA
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="outside_usa" name="shipping_type[]" 
                                        {{ isset($shipping_types["outside_usa"]) ? 'checked' : ''  }}  id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Outside USA
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row mt-3">
                            <label class="col-md-3 col-from-label">{{translate('Shipping price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-3">
                                <input type="number" lang="en" min="0" value="{{ $product->shipping_charge }}" name="shipping_charge" class="form-control" required>
                            </div>
                        </div>
                        <!-- <div class="form-group row">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-3" id="delivery_option">
                             ...
                             <div class="input-type-check d-flex flex-wrap ml-5">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="global"  name="delivery_option[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Global
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="limited_international" name="delivery_option[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Limited International
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="national" name="delivery_option[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            National
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="limited_national" name="delivery_option[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Limited National
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="locak_delivery" name="delivery_option[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Locak Delivery
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="picup" name="delivery_option[]" id="flexCheckChecked">
                        ...
                        <div class="form-group row mt-3" id="shipping_type">
                             ...
                             <div class="input-type-check d-flex flex-wrap ml-5">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="within_usa"  name="shipping_type[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Within USA
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="outside_usa" name="shipping_type[]" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Outside USA
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-md-3">
                                <input type="number" lang="en" min="0" value="" step="0.01" placeholder="{{ translate('Shipping price') }}" name="shipping_price" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>

                            ...
                            @if (addon_is_activated('seller_subscription'))
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('seller_packages.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Merchant Packages') }}</span>
                                        @if (env("DEMO_MODE") == "On")
                                            <span class="badge badge-inline badge-danger">Addon</span>
                                        @endif
                                    </a>
                ...
                @endif
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                         ...
                         <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="admin.faq" class="aiz-side-nav-link {{ areActiveRoutes(['staffs.index', 'staffs.create', 'staffs.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('FAQS')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="admin.terms" class="aiz-side-nav-link {{ areActiveRoutes(['roles.index', 'roles.create', 'roles.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Terms and Condition')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>

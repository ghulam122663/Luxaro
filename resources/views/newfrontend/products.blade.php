                     ...
                     <div class="d-md-flex justify-content-between align-items-center flex-wrap mb-3">
                         <div class="mb-3 mb-md-0">
                             <ol class="breadcrumb mb-1">
                                 ...
                                 <li class="breadcrumb-item active" aria-current="page">Search Results - [Search term(s)]</li>
                             </ol>
                             <h2>Search results - "[Search terms]"
                         </div>
                         <div class="mb-3 mb-md-0">
                                 ...
                                 <div class="product-item">
                                     ...
                                     <div class="txt-holder">
                                         ...
                                         <div class="d-flex justify-content-between align-items-center">
                                             <strong class="title">{{$product->unit_price}}</strong>

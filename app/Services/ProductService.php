...
class ProductService
{
    public function store(array $data)
    {
        ...
        $collection['delivery_option'] = implode(',', $delivery_option);
    ...
    public function update(array $data, Product $product)
    {
        ...
        $collection['delivery_option'] = implode(',', $data['delivery_option']);
        $collection['shipping_type'] = implode(',', $data['shipping_type']);
